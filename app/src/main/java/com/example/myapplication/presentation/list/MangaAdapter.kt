...
class MangaAdapter(private var dataSet: List<Manga>, private var listener: ((Int)->Unit)? = null) :
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            imageView= view.findViewById(R.id.manga_img)
        }
    }
